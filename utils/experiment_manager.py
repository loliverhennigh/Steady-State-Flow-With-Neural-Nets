...
NOT_PATH_ANY = ['base_dir_flow', 'base_dir_boundary', 'batch_size', 'display_test', 'test_set', 'max_steps', 'test_set', 'boundary_learn_loss', 'shape', 'boundary_learn_loss', 'boundary_learn_lr', 'boundary_learn_steps', 'lb_seq_length']
